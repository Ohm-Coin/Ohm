...
unsigned int nStakeMinAge = 60 * 30;	// minimum age for coin age: 30m
unsigned int nStakeMaxAge = 60 * 60 ;	// stake age of full weight: 1hr
...
const string strMessageMagic = "Ohm Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Ohm
    bool fStrictPayToScriptHash = true; // Always active in Ohm
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Ohm", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
